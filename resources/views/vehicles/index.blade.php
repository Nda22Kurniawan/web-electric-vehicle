                ...
                <table class="table table-bordered table-hover" id="vehiclesTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($vehicle->color)
                                    <span class="badge" style="background-color: {{ $vehicle->color }}">
                                        {{ $vehicle->color }}
                                    </span>
                                @else
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('vehicles.show', $vehicle->id) }}" class="btn btn-info btn-sm" title="Detail">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('vehicles.edit', $vehicle->id) }}" class="btn btn-warning btn-sm" title="Edit">
