...
@section('page-subtitle', 'Edit layanan servis')
            ...
            <form action="{{ route('services.update', $service) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('duration_estimate') is-invalid @enderror" id="duration_estimate" name="duration_estimate" value="{{ old('duration_estimate', $service->duration_estimate) }}" min="1">
